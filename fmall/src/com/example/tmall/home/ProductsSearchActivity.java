...
import com.example.tmall.classify.ClickListener;
import com.example.tmall.classify.DetailActivity;
import com.example.tmall.classify.DividerItemDecoration;
import com.example.tmall.classify.ProductsAdapter;
import com.example.tmall.classify.RecyclerTouchListener;
 ...
 * 商品列表
 */
public class ProductsSearchActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sql_query=intent.getStringExtra(ClassifyFragment.CLASSIFY);
		initView();
	}
	private void initView() {
			...
			public void onRefresh() {
				refreshLayout.postDelayed(new Runnable() {
					...
					public void run() {
						...
						Toast.makeText(ProductsSearchActivity.this, "刷新成功", Toast.LENGTH_SHORT).show();
					}
				}, 2000);
        ...
        //
      	mAdapter=new ProductsAdapter(productsList, ProductsSearchActivity.this);
      	recyclerView.setAdapter(mAdapter);
        //
        recyclerView.addItemDecoration(new DividerItemDecoration(this));
        //
        recyclerView.setItemAnimator(new DefaultItemAnimator());
		recyclerView.addOnItemTouchListener(new RecyclerTouchListener(ProductsSearchActivity.this, recyclerView, new ClickListener() {
			...
			public void onClick(View view, int position) {
				// 
				Intent intent=new Intent(ProductsSearchActivity.this,DetailActivity.class);
		...
		new ProductListTask().execute(HttpUrl.SEARCH_URL+sql_query);
	}
